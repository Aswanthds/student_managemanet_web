...
import 'package:student_management_web/widgets/edit_student_form.dart';
  ...
  Widget build(BuildContext context) {
    Widget imageWidget = isImageSelected
        ? Row(
            ...
            children: [
              Image.network(
                'https://firebasestorage.googleapis.com/v0/b/studentmanagemnetweb.appspot.com/o/StudentImages%2F$initValue?alt=media&token=2df4a60b-1f89-4710-8d1a-2bd00e4380b9',
                height: 80,
                width: 80,
              ),
              Row(
                ...
                children: [
                  IconButton(
                    onPressed: () async {
                      if (isImageSelected) {
                        await FirebaseFunctions.deleteImageFromStorage(widget
                                .student[
                            'path']); // Delete the image from Firebase Storage
                      }
                      setState(() {
                        isImageSelected = false;
                        imageFile = '';
                        initValue = filename; // Clear the image file name
                      });
                    },
